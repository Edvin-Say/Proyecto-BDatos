...
public class control_existencias 
{
    ...
    public void setId_articulo(String id_articulo) {
      ...
      public Object[][] datos_detallefactura(String numero_factura)
     {
      ...
      public Object[][] consulta_empleados(String id)
       {
        ...
        Object[][] resultado2 = sen.GetTabla(columnas, "rrhh", "select * from rrhh where Id_empleado = '"+id+"';");
        return resultado2;
       }
      
      public Object[][] consulta_empleados2(String id)
       {
        String[] columnas={"Id_empleado","CUI","Apellidos","Nombre","Direccion","Fecha_nacimiento","Telefono","Fecha_contrato","Genero","Estado_civil","Email","Cargo","Horario","Salario","Estado"};
        Object[][] resultado2 = sen.GetTabla(columnas, "rrhh", "delete * from rrhh");
        return resultado2;
       }
